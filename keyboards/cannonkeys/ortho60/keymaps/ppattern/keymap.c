...
/*#define FN1 LT(_RAISE, KC_MINS)*/
/*#define FN2 LT(_LOWER, KC_EQL)*/
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl |  Opt | GUI  |Lower |Space |    Enter    |Space |Raise | GUI  |  Opt | Ctrl |
   * `-----------------------------------------------------------------------------------'
   */
...
LSFT_T(KC_CAPS), KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  RSFT_T(KC_ENT), \
       KC_LCTL,  KC_LALT,  KC_LGUI,  LOWER,    SPACE,    ENTER,    ENTER,    SPACE,    RAISE,    RGUIT,    RALTT,    RCTLT \
),
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_VIMQ] = LAYOUT_ortho_5x12( \
       KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_BSPC, \
       KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     I_VIMD,   O_VIMD,   KC_P,     KC_BSLS, \
 ...
 * | Shift|      |      |      |      |      |      |   <  |  / ? |   >  |      |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  Opt | GUI  |      |Space |    Enter    |Space | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_ortho_5x12( \
       ...
       KC_TRNS,  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_LT,    KC_SLSH,  KC_GT,    KC_NO,    KC_TRNS, \
 ...
 * | Tab  |      |  UP  |      |      |      |      |      |      |      |      |PrtScr|          Raise
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Esc  | Left | Down |Right |      |      |      |  Ins | HOME | PgUp |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Shift|      |      |      |      |      |      |  Del |  End | PgDn |      |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  Opt | GUI  |Lower |Space |    Enter    |Space |      | Mute | Vol- | Vol+ |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_ortho_5x12( \
       KC_TILD,  KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,   KC_PERC,  KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,  KC_NO, \
       KC_TRNS,  KC_NO,    KC_UP,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_PSCR, \
       KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_NO,    KC_NO,    KC_NO,    KC_INS,   KC_HOME,  KC_PGUP,  KC_NO,    KC_NO, \
       KC_TRNS,  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_DEL,   KC_END,   KC_PGDN,  KC_NO,    KC_TRNS, \
       KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC__MUTE, KC_VOLD,  KC_VOLU \
),

/* Plover layer (http://opensteno.org)
 * ,-----------------------------------------------------------------------------------.
 * | Exit |      |      |      |      |      |      |Numlck|      |      |  Del | Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Exit |      |      |      |Space |    Enter     |  0  | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_PLOVER] = LAYOUT_ortho_5x12( \
       EXT_PLV,  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,  KC_NUMLOCK, KC_NO,    KC_NO,    KC_DEL,   KC_BSPC, \
       ...
       EXT_PLV,  KC_NO,    KC_NO,    KC_BSPC,  KC_SPC,   KC_ENT,   KC_ENT,   KC_P0,    KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT \
),
...
[_ADJUST] = LAYOUT_ortho_5x12( \
 ...
 EEPROM_RESET,   RESET,    DEBUG,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    VIMQ,     VIMD,     KC_NO,    KC_NO,    KC_NO, \
       KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    QWERTY,   COLEMAK,  DVORAK,   PLOVER,   KC_NO, \
