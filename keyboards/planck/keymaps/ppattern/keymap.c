...
[_QWERTY] = LAYOUT_planck_2x2u(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, LOWER,       KC_SPC,           KC_ENT,       RAISE,   KC_RGUI, KC_LEFT, KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_2x2u(
    ...
    KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10, KC_F11, KC_F12,  KC_LPRN, KC_RPRN, KC_NO,   KC_NO,   RSFT_T(KC_ENT),
    KC_LCTL, KC_LALT, KC_LGUI, KC_TRNS,       KC_SPC,         KC_ENT,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_planck_2x2u(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,     KC_0,     KC_BSLS,
    KC_TAB,  KC_NO,   KC_NO,   KC_UP,   KC_NO,   KC_NO,   KC_INS,  KC_HOME, KC_PGUP, KC_NO,    KC_NO,    KC_NO,
    KC_LSFT, KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,   KC_DEL,  KC_END,  KC_PGDN, KC_NO,    KC_NO,    RSFT_T(KC_ENT),
    KC_LCTL, KC_LALT, KC_LGUI, KC_TRNS,      KC_SPC,          KC_ENT,       KC_TRNS, KC__MUTE, KC_VOLD,  KC_VOLU
),
